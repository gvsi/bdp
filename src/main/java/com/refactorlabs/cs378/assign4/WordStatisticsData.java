...
public class WordStatisticsData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4209524291373121124L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WordStatisticsData\",\"namespace\":\"com.refactorlabs.cs378.assign4\",\"fields\":[{\"name\":\"docCount\",\"type\":\"long\"},{\"name\":\"totalCount\",\"type\":\"long\"},{\"name\":\"min\",\"type\":\"long\"},{\"name\":\"max\",\"type\":\"long\"},{\"name\":\"sumOfSquares\",\"type\":\"long\"},{\"name\":\"mean\",\"type\":\"double\",\"default\":0.0},{\"name\":\"variance\",\"type\":\"double\",\"default\":0.0}]}");
  ...
  @Deprecated public long sumOfSquares;
   ...
   * @param docCount The new value for docCount
   * @param totalCount The new value for totalCount
   * @param min The new value for min
   * @param max The new value for max
   * @param sumOfSquares The new value for sumOfSquares
   * @param mean The new value for mean
   * @param variance The new value for variance
   */
  public WordStatisticsData(java.lang.Long docCount, java.lang.Long totalCount, java.lang.Long min, java.lang.Long max, java.lang.Long sumOfSquares, java.lang.Double mean, java.lang.Double variance) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: docCount = (java.lang.Long)value$; break;
    case 1: totalCount = (java.lang.Long)value$; break;
    case 2: min = (java.lang.Long)value$; break;
    case 3: max = (java.lang.Long)value$; break;
    case 4: sumOfSquares = (java.lang.Long)value$; break;
   ...
   * @return The value of the 'docCount' field.
   */
  ...
  /**
   * Gets the value of the 'sumOfSquares' field.
   * @return The value of the 'sumOfSquares' field.
   */
  ...
  /**
   * Sets the value of the 'sumOfSquares' field.
   * @param value the value to set.
   */
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WordStatisticsData>
    ...
    private Builder(com.refactorlabs.cs378.assign4.WordStatisticsData.Builder other) {
      ...
      if (isValidValue(fields()[4], other.sumOfSquares)) {
        this.sumOfSquares = data().deepCopy(fields()[4].schema(), other.sumOfSquares);
    ...
    /**
      * Sets the value of the 'docCount' field.
      * @param value The value of 'docCount'.
      * @return This builder.
      */
    ...
    /**
      ...
      * @return True if the 'docCount' field has been set, false otherwise.
      */
    ...
    /**
      * Sets the value of the 'sumOfSquares' field.
      * @param value The value of 'sumOfSquares'.
      * @return This builder.
      */
    ...
    /**
      * Checks whether the 'sumOfSquares' field has been set.
      * @return True if the 'sumOfSquares' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'sumOfSquares' field.
      * @return This builder.
      */
    ...
    public WordStatisticsData build() {
      try {
        ...
        record.docCount = fieldSetFlags()[0] ? this.docCount : (java.lang.Long) defaultValue(fields()[0]);
        record.totalCount = fieldSetFlags()[1] ? this.totalCount : (java.lang.Long) defaultValue(fields()[1]);
        ...
        record.sumOfSquares = fieldSetFlags()[4] ? this.sumOfSquares : (java.lang.Long) defaultValue(fields()[4]);
