...
public class ModifiedUserSessions extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "ModifiedUserSessions");
        // Identify the JAR file to replicate to all machines.
        job.setJarByClass(ModifiedUserSessions.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new ModifiedUserSessions(), args);
        System.exit(res);
    }
}
